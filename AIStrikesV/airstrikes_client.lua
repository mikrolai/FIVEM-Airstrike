...
local v = vector3(blipX, blipY, blipZ)


print ("	####			Führe Airstrike aus...				####")
print ("	####			Detonation erfolgt in ca. 30 sek.	####")
print ("	####			Koordinaten:						####")
print (v)

local blip4 = AddBlipForArea(blipX, blipY, blipZ, 50.0, 50.0)
SetBlipRotation(blip4, 0)
SetBlipColour(blip4, 1)

  if args[1] == "light" or args[1] == "medium" or args[1] == "heavy" or args[1] == "armageddon" then
    TriggerEvent("Airstrike:Execute",blipX,blipY,blipZ,args[1])
Wait(30000)
RemoveBlip(blip4)
  ...
  elseif attacktype == "medium" and not IsAttackOnGoing then
    ...
    aircraft1 = CreateVehicle(hash, blipX +1000, blipY +1000, blipZ +800, 216.675, true, true)
    pilot1 = CreatePedInsideVehicle(aircraft1, 1, modelHash, -1, true, true)
    aircraft2 = CreateVehicle(hash, blipX +1100, blipY +1050, blipZ +800, 216.675, true, true)
    pilot2 = CreatePedInsideVehicle(aircraft2, 1, modelHash, -1, true, true)
    aircraft3 = CreateVehicle(hash, blipX +1200, blipY +1100, blipZ +800, 216.675, true, true)
...
-- ShowAdvNotification(image, title, subtitle, message)
SetNotificationBackgroundColor (6)
ShowAdvNotification("CHAR_LESTER_DEATHWISH", "Airstrike!", "~u~Airstrike wird ausgeführt!!")
    ...
    while (not IsEntityDead(pilot1)) or (not IsEntityDead(pilot2)) or (not IsEntityDead(pilot3))  do
      if (x-30)<GetEntityCoords(aircraft1).x and GetEntityCoords(aircraft1).x<(x+30) and (y-30)<GetEntityCoords(aircraft1).y and GetEntityCoords(aircraft1).y<(y+30) and not isAttack1Done  then
        ...
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 2.0, -1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 4.0, 6.2, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 6.0, -1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 8.0, 3, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 10.0, 4.32, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 12.0, 6.1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 14.0, 1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 16.0, 1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 18.0, 1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 20.0, 1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 22.0, 1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 24.0, 1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 26.0, 1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 28.0, -1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 30.0, 6.2, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 32.0, -1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 34.0, 3, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 36.0, 4.32, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 38.0, 6.1, 0)
        Wait(25)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, 40.0, 1, 0)
		Wait(25)
		ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft1).x, GetEntityCoords(aircraft1).y, GetEntityCoords(aircraft1).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 0.0, -2.0, -1, 0)
        Wait(25)
      ...
      if (x-30)<GetEntityCoords(aircraft2).x and GetEntityCoords(aircraft2).x<(x+30) and (y-30)<GetEntityCoords(aircraft2).y and GetEntityCoords(aircraft2).y<(y+30) and not isAttack2Done then
        ...
        local offset = GetObjectOffsetFromCoords(x, y, z, 2.0, 0.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 4.0, 0.0, 6.2, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 6.0, 0.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 8.0, 0.0, 3, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 10.0, 0.0, 4.32, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 12.0, 0.0, 6.1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 14.0, 0.0, 1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 16.0, 0.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 18.0, 0.0, 6.2, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 20.0, 0.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 22.0, 0.0, 3, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 24.0, 0.0, 4.32, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 26.0, 0.0, 6.1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 28.0, 0.0, 1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 30.0, 0.0, 6.2, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 32.0, 0.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 34.0, 0.0, 3, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 36.0, 0.0, 4.32, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 38.0, 0.0, 6.1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 40.0, 0.0, 1, 0)
		Wait(10)
		ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -2.0, 0.0, -1, 0)
        Wait(10)
        ...
        local offset = GetObjectOffsetFromCoords(x, y, z, -40.0, 0.0, 1, 0)
			Wait(10)
		ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -2.0, 2.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -4.0, 4.0, 6.2, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -6.0, 6.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -8.0, 8.0, 3, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -10.0, 10.0, 4.32, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -12.0, 12.0, 6.1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -14.0, 14.0, 1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -16.0, 16.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -18.0, 18.0, 6.2, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -20.0, 20.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -22.0, 22.0, 3, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -24.0, 24.0, 4.32, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -26.0, 26.0, 6.1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -28.0, 28.0, 1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -30.0, 30.0, 6.2, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -32.0, 32.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -34.0, 34.0, 3, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -36.0, 36.0, 4.32, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -38.0, 38.0, 6.1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft2).x, GetEntityCoords(aircraft2).y, GetEntityCoords(aircraft2).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, -40.0, 40.0, 1, 0)	
        Wait(15000)
      ...
      if (x-30)<GetEntityCoords(aircraft3).x and GetEntityCoords(aircraft3).x<(x+30) and (y-30)<GetEntityCoords(aircraft3).y and GetEntityCoords(aircraft3).y<(y+30) and not isAttack3Done then
        ...
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft3).x, GetEntityCoords(aircraft3).y, GetEntityCoords(aircraft3).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 16.0, 16.0, 6.2, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft3).x, GetEntityCoords(aircraft3).y, GetEntityCoords(aircraft3).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 18.0, 18.0, -1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft3).x, GetEntityCoords(aircraft3).y, GetEntityCoords(aircraft3).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 20.0, 20.0, 3, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft3).x, GetEntityCoords(aircraft3).y, GetEntityCoords(aircraft3).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 22.0, 22.0, 4.32, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft3).x, GetEntityCoords(aircraft3).y, GetEntityCoords(aircraft3).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 24.0, 24.0, 6.1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft3).x, GetEntityCoords(aircraft3).y, GetEntityCoords(aircraft3).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 26.0, 26.0, 1, 0)
        Wait(10)
        ShootSingleBulletBetweenCoords(GetEntityCoords(aircraft3).x, GetEntityCoords(aircraft3).y, GetEntityCoords(aircraft3).z-20.0,offset.x,offset.y,offset.z, 5000, 0, GetHashKey("VEHICLE_WEAPON_SPACE_ROCKET"), PlayerPedId(), true, false, 9000.0)
        local offset = GetObjectOffsetFromCoords(x, y, z, 28.0, 28.0, -1, 0)
        Wait(10)
...
ShowAdvNotification("CHAR_LESTER_DEATHWISH", "Airstrike!", "~g~Airstrike verfügbar!")
        end)
      end
      Wait(0)
    end
